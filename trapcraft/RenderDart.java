...
public class RenderDart extends Render {
	public void renderDart(EntityDart entityDart, double par2, double par4, double par6, float par8, float par9) {
		loadTexture("/item/arrows.png");
		GL11.glPushMatrix();
		GL11.glTranslatef((float) par2, (float) par4, (float) par6);
		GL11.glRotatef((entityDart.prevRotationYaw + (entityDart.rotationYaw - entityDart.prevRotationYaw) * par9) - 90F,
				0.0F, 1.0F, 0.0F);
		GL11.glRotatef(entityDart.prevRotationPitch + (entityDart.rotationPitch - entityDart.prevRotationPitch) * par9,
				0.0F, 0.0F, 1.0F);
		...
		float f9 = (float) entityDart.arrowShake - par9;
	...
	public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9) {
		renderDart((EntityDart) par1Entity, par2, par4, par6, par8, par9);
	}
}
